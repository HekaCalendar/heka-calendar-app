...
function useCelestialData(
  ...
  display: { showSeasonalEvents: boolean; showAgriculturalGuidance: boolean; showEnergyForecast: boolean }
) {
  return useMemo(() => {
    const nextSeasonalEvent = display.showSeasonalEvents 
    ...
    return {
      ...
      agGuidance: display.showAgriculturalGuidance 
        ? getAgriculturalGuidance(civilDate, hemisphere) 
        : null,
      energyForecast: display.showEnergyForecast 
      ...
      currentSeason: display.showSeasonalEvents 
        ? getCurrentSeason(civilDate, hemisphere) 
        : null,
      daysUntilNextSeason: display.showSeasonalEvents 
        ? getDaysUntilNextSeason(civilDate, hemisphere) 
        : 0,
    };
  }, [civilDate, hemisphere, locationData, display.showSeasonalEvents, display.showAgriculturalGuidance, display.showEnergyForecast]);
}
...
const CelestialPanelComponent: React.FC = () => {
  ...
  return (
    <div className="celestial-panel-container">
      ...
      {display.showSeasonalEvents && celestialData.currentSeason && (
        <ExpandableCelestialCard
      ...
      {display.showSeasonalEvents && celestialData.nextSeasonalEvent && seasonalEventInfo && (
        <ExpandableCelestialCard
      ...
      {display.showAgriculturalGuidance && celestialData.agGuidance && (
        <ExpandableCelestialCard
      ...
      {display.showEnergyForecast && celestialData.energyForecast && (
        <ExpandableCelestialCard
          title="Cosmic Energy"

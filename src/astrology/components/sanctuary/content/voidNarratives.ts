...
export const signEssences: Record<string, SignEssence> = {
  ...
  ophiuchus: { sign: "Ophiuchus", symbol: "⛎", element: "water", modality: "fixed", essence: "The healing, the wisdom-keeping, the serpent-bearer", voidAtmosphere: "Like a medicine bag in silence", color: "#059669", landscape: "Ancient healing temple at dusk" },

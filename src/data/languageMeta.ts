/**
 * Lightweight language metadata used by the core app boot path.
 *
 * The full wizard translation strings live in languages.ts and are loaded
 * on-demand by the lazy SetupWizard, so they do not bloat the initial bundle.
 */
